...
public class SavedCartContainerController {
    ...
    HistoryCartsController parent;
    Model m = Model.getInstance();
    public SavedCartContainerController(HistoryCartsController _parent, List<ShoppingItem> _items, String name, SavedCartContainerPanel _view){
        this.items = _items;
        this.view = _view;
        this.parent = _parent;
